  ...
  group('Device Session Service Tests', () {
    ...
    group('Active Sessions', () {
      ...
      test('TC-DEVICE-006: Session limit enforced (max 5 devices)', () {
        const maxDevices = 5;
        const currentDevices = 6;

        const exceedsLimit = currentDevices > maxDevices;
    ...
    group('Device Logout', () {
      test('TC-DEVICE-009: Single device logout', () async {
        ...
        final sessions = ['{"deviceId":"device1"}', '{"deviceId":"device2"}'];
      ...
      test('TC-DEVICE-010: Logout all other devices', () async {
        ...
        await prefs.setStringList('active_sessions', [
          '{"deviceId":"current"}',
        ]);
    ...
    group('Activity Tracking', () {
      ...
      test('TC-DEVICE-016: Inactive session timeout', () {
        final lastActivity = DateTime.now().subtract(const Duration(days: 31));
        const timeout = Duration(days: 30);
