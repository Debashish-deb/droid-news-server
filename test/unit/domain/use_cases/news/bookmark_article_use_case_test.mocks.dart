...
class MockNewsRepository extends _i1.Mock implements _i2.NewsRepository {
  ...
  @override
  _i3.Future<_i4.Either<_i5.AppFailure, int>> syncNews({
    required _i8.Locale? locale,
    bool? force = false,
    String? category,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Stream<List<_i6.NewsArticle>> watchArticles(
    String? category,
    _i8.Locale? locale,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i3.Stream<List<_i6.NewsArticle>>.empty(),
      ) as _i3.Stream<List<_i6.NewsArticle>>);
}
