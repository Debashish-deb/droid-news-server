  ...
  group('Premium Payment Flow Tests', () {
    ...
    group('Subscription Activation', () {
      ...
      test('TC-PAYMENT-007: Trial period activated', () async {
        ...
        final trialEnd = DateTime.now().add(const Duration(days: 7)).millisecondsSinceEpoch;
    ...
    group('Subscription Expiry', () {
      ...
      test('TC-PAYMENT-013: Expired subscription downgraded', () async {
        ...
        // Set past expiry
        final pastExpiry = DateTime.now().subtract(const Duration(days: 1)).millisecondsSinceEpoch;
    ...
    group('Billing Cycles', () {
      test('TC-PAYMENT-021: Monthly billing cycle', () async {
        ...
        await prefs.setInt('next_billing_date', DateTime.now().add(const Duration(days: 30)).millisecondsSinceEpoch);
      ...
      test('TC-PAYMENT-022: Yearly billing cycle with discount', () async {
        ...
        await prefs.setInt('next_billing_date', DateTime.now().add(const Duration(days: 365)).millisecondsSinceEpoch);
