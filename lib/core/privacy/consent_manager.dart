...
class ConsentManager {
  ...
  bool get canReportCrashes =>
      _prefs.getBool(_keyCrashReportingConsent) ?? false; // ✅ FIXED: Default to false for privacy
  ...
  Future<void> resetAllConsents() async {
    if (!_initialized) return;
    await _prefs.setBool(_keyAnalyticsConsent, false);
    await _prefs.setBool(_keyPersonalizationConsent, false);
    await _prefs.setBool(_keyCrashReportingConsent, false);
  }
}
