...
class SourceLogos {
  ...
  static const Map<String, String> logos = <String, String>{
    ...
    'TechCrunch': 'assets/logos/tech_crunch.png',
    'Ars Technica': 'assets/logos/ars-technica.png',
