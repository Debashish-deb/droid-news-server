...
class _RemoveAdsScreenState extends ConsumerState<RemoveAdsScreen> {
  ...
  Future<void> _handlePurchaseUpdates(List<PurchaseDetails> purchases) async {
    for (final purchase in purchases) {
      if (purchase.status == PurchaseStatus.purchased ||
        ...
        final repository = ref.read(subscriptionRepositoryProvider);
        final result = await repository.processStorePurchase(purchase);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _buildBody(theme, purchaseActivationAvailable),
    );
  }

  Widget _buildBody(ThemeData theme, bool purchaseActivationAvailable) {
    if (_isLoading) {
    ...
    return _buildPurchaseState(theme, purchaseActivationAvailable);
  }
  ...
  Widget _buildPurchaseState(ThemeData theme, bool purchaseActivationAvailable) {
        ...
        children: [
          if (!purchaseActivationAvailable)
            Container(
              ...
              child: const Text(
                'Purchases are temporarily disabled until verification backend is available.',
              ),
            ),
          ...
          ElevatedButton.icon(
            onPressed: purchaseActivationAvailable ? _buyPremium : null,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildBenefitItem(
              '✓',
              AppLocalizations.of(context).adFreeExperienceBenefit,
              theme,
            ),
            _buildBenefitItem(
              '✓',
              AppLocalizations.of(context).supportAppDevelopmentBenefit,
              theme,
            ),
            _buildBenefitItem(
              '✓',
              AppLocalizations.of(context).oneTimePaymentBenefit,
              theme,
            ),
            _buildBenefitItem(
              '✓',
              AppLocalizations.of(context).prioritySupportBenefit,
              theme,
            ),
          ],
        ),
