...
class _MagazineCardState extends ConsumerState<MagazineCard> {
  void _open(BuildContext context) {
    ...
    final String title =
        widget.magazine['name'] as String? ?? loc.unknownMagazine;
    if (url.isEmpty) {
  ...
  String? _getLocalLogoPath() {
    final media = widget.magazine['media'];
    if (media != null) {
  ...
  Widget build(BuildContext context) {
    ...
    final String initials = (widget.magazine['name'] as String? ?? 'MG')
        .substring(0, 2)
        .toUpperCase();
                      ...
                      Container(
                        decoration: const BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: <Color>[Colors.white30, Colors.transparent],
                          ),
                        ),
                      ),
