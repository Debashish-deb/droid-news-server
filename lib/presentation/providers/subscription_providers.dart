...
/// Release gate for new premium activations.
final purchaseActivationAvailableProvider = Provider<bool>((ref) {
  return ref.watch(di.paymentServiceProvider).isPurchaseActivationAvailable;
});
